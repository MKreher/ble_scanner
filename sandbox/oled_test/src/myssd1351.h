...
#define RESET_PORT GPIO_PORT_RST
#define RESET_PIN GPIO_PIN_RST
#define DC_PORT GPIO_PORT_DC
#define DC_PIN GPIO_PIN_DC
#define CS_PORT GPIO_PORT_CS
#define CS_PIN GPIO_PIN_CS
