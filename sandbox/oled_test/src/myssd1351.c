...
void SSD1351_init(void) {
  ...
  //SSD1351_write_data(0b00100000); // rotate 0
  //SSD1351_write_data(0b00100011); // 270
  SSD1351_write_data(0b00110010); // 180
  //SSD1351_write_data(0b00110001); // 90
  ...
  SSD1351_write_command(SSD1351_CMD_DISPLAYENHANCE);
